...
$pdf->Cell(0, 10, 'Daftar merek', 0, 1, 'L');
$pdf->Ln(3);
...
$pdf->Cell(85, 10, 'idmerek', 1, 0, 'C');
$pdf->Cell(85, 10, 'merek', 1, 1, 'C');
...
while ($row = $result->fetch_assoc()) {
    $pdf->Cell(20, 10, $no++, 1, 0, 'C');
    $pdf->Cell(85, 10, $row['idmerek'], 1, 0, 'C');
    $pdf->Cell(85, 10, $row['merek'], 1, 1, 'C');

}


//output pdf
$pdf->Output('I', 'Daftar_merek.pdf');
